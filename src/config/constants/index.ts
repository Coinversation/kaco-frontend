...
import { BUSD, DAI, USDT, BTCB, Kaco, WBNB, USDC, ChainId, JPYC, ETH } from './tokens';
...
// used to ensure the user doesn't send so much BNB so they end up with <0.00000001
export const MIN_BNB: JSBI = JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(10)); // 0.00000001 BNB
